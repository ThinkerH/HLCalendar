...
- (void)viewDidLoad {
    ...
    _monthes = [[HLCalendar shareInstance] monthsWithDate:[NSDate date] monthes:_monthesNum != 0 ? _monthesNum : calendarLenth];
    _dateSource = [[HLCalendar shareInstance] calendarDataWithMonthes:_monthesNum != 0 ? _monthesNum : calendarLenth fromDate:[NSDate date]];
...
- (void)setupCollectionView {
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT) collectionViewLayout:flowLayot];
